...
class studentobj implements ActionListener
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		frame.setTitle("Id card generator");
			...
			btn2.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent e)
				{
					...
					s.Address = f.getText();
					String str=Integer.toString(s.Id_no)+"#"+s.First_name+"#"+s.Last_name+"#"+s.Date_of_birth+"#"+s.Phone_no+"#"+s.Blood_group+"#"+s.Address;
					try {
			...
			btn1.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent e)
		{
			...
			btn3.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent e)
				{
			...
			btn4.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent e)
				{
					frame1.dispose();
				}
			});
